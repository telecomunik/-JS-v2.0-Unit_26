...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=3&num2=5')
        .then(data => data.text())
        .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=0&num2=100')
        .then(data => data.text())
        .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=12&num2=7')
        .then(data => data.text())
        .then(data => {
...
function t10() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        .then(response => {
            document.querySelector('.out-10').innerText = response;;
        })
}
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-11').innerText = response;;
        })
}
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=27&num2=23',
    })
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-12').innerText = response;;
        })
}
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=1&num2=99',
    })
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-13').innerText = response;;
        })
}
...
function t14() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-14').innerText = response;;
        })
}
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=1&num2=99',
    })
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-15').innerText = response;;
        })
}
...
function t16() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-16').innerText = response;;
        })
}
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-17').innerText = response;;
        })
}
...
function t18() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-18').innerText = response;;
        })
}
